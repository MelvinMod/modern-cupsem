...
### Qué se necesita para gráficos completos:
Instale gnuplot como se muestra arriba, entonces las funciones de trazado en `graphics_gnuplot.rb` ¡funcionarán para la salida visual!
